...
$hasSetupOptions = is_dir($sources['build'] . 'install.options'); /* HTML/PHP script to interact with user */
...
$templates = include dirname(__FILE__).'/data/transport.policytemplate.php';
$attributes = array (
    xPDOTransport::PRESERVE_KEYS => false,
    xPDOTransport::UNIQUE_KEY => array('name'),
    xPDOTransport::UPDATE_OBJECT => true,
