 ...
 * @package Campaigner
 */
class campaignerConnectorRequest extends modConnectorResponse
{
    function __construct(Campaigner &$campaigner, array $config = array())
    {
        parent::__construct($campaigner->modx, $config);
